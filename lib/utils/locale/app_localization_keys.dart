class LocalizationKeys {
  ...
  static const jussur = 'jussur';
  static const productsAndCategories = 'products_and_categories';
  static const searchHint = 'search_hint';
  static const searchMapsHere = 'search_maps_here';
  static const hotDeals = 'hot_deals';
  static const seeAll = 'see_all';
  static const selectedCategories = 'selected_categories';
  static const featured = 'featured';
  static const newItems = 'new_items';
  static const currencySAR = 'currency_sar';
  static const bestSeller = 'best_seller';
  static const all = 'all';
  static const enterOtpMsg = 'enter_otp_msg';
  static const resendCode = 'resend_code';
  static const verify = 'verify';
  static const otpExpireOn = 'otp_expire_on';
  ...
  static const similarProduct = 'similar_product';
  static const madeIn = 'made_in';
  ...
  static const phoneNumberExp = 'phone_number_exp';
  static const String changeInputs = 'change_inputs';
  static const String resultNotFound = 'result_not_found';
  static const String weCouldNotFindWhatYouAreLookingFor =
      'we_could_not_find_what_you_are_looking_for';
  static const String searchJussurSa = 'search_jussur_sa';
